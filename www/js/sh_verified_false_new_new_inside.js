$(document).on('pageshow', '#sh_verified_false_new_new_inside', function(){  
...
if(x !== 'New'){
$.ajax({url: "http://staging.eimpressive.com/slim-fourth/insertbut.php?name="+name+"&verification_user_id="+verification_user_id+"&verification_for="+verification_for+"&current_address="+current_address+"&location="+location+"&state="+state+"&qualification_name="+qualification_name+"&task_name="+task_name+"&type="+type,
...
$.ajax({
  type: "POST",
  url: "http://staging.eimpressive.com/slim-fourth/insertbut.php?name="+name+"&verification_user_id="+verification_user_id+"&verification_for="+verification_for+"&current_address="+current_address+"&location="+location+"&state="+state+"&qualification_name="+qualification_name+"&task_name="+task_name+"&type="+type,
